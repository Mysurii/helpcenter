...
function NotFound () {
  return (
    <div className="flex justify-center flex-col items-center mt-[20vh]">
      <h1 className="text-3xl text-indigo-500 font-bold">404 Not found</h1>
      <p className='text-lg text-indigo-500'>Looks like this page is missing. Please go back to the homepage.</p>
